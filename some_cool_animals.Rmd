...
We'll also learn about `knitr::include_graphics()` (there are a lot of options for putting images in rmds)

Add a few fun facts:
-  Can rotate hind feet 180 degrees (so they are really good at climbing)
